...
class TrainDataset(Dataset):
    def __init__(self):
        self.data_2023 = np.load("dataset/total_data_2023.npy")
        self.data_2023 = self.data_2023[0:720+744+720,:,:,:]  # first 3 month of 2023
...
class ValidationDataset(Dataset):
    def __init__(self):
        self.data_2023 = np.load("dataset/total_data_2023.npy")
        self.data_2023 = self.data_2023[720+744+720:720+744+720+744//2,:,:,:]  # first half of last month of 2023
        self.total_hours = self.data_2023.shape[0]
        self.feature_count = self.data_2023.shape[1]
        self.dim = self.data_2023.shape[2]
        self.past_hours = 6
...
class TestDataset(Dataset):
    def __init__(self):
        self.data_2023 = np.load("dataset/total_data_2023.npy")
        self.data_2023 = self.data_2023[720+744+720+744//2:,:,:,:]  # last half of last month of 2023
        self.total_hours = self.data_2023.shape[0]
        self.feature_count = self.data_2023.shape[1]
        self.dim = self.data_2023.shape[2]
        self.past_hours = 6
